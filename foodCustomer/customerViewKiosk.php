...
<body>
    ...
    <div class="container">
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4">
            ...
            <?php
                $sql = "SELECT * FROM kiosk WHERE kiosk_status= 'Open'";
            ...
            <form action="">
                <div class="col">
                    <a href="<?php echo SITEURL;?>foodCustomer/customerManageMenu.php?kiosk_id=<?php echo $kioskId; ?>" class="no-underline text-reset">
